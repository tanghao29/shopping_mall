...
import com.huayu.shopping_mall.realm.CustomRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/shopping_mall/orderform/**", "authc");

        //管理员角色才可以访问
        filterChainDefinitionMap.put("/shopping_mall/orderform/**", "roles[admin,root]");
